/**
 * Motion-Modul für small p club.
 *
 * Re-exportiert Konstanten + Hooks aus einem Folder, damit der Import-Pfad
 * `@/lib/motion` konsistent für beides funktioniert (Eases, Durations,
 * Hooks). Auflösungs-Mehrdeutigkeit zwischen `motion.ts` und `motion/`
 * ist damit weg.
 *
