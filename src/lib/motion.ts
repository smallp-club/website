...
/* ------------------------------------------------------------------ */
/* Hooks (re-export — bis motion.ts/motion/ vollständig konsolidiert) */
/* ------------------------------------------------------------------ */

export { useRevealOnIntersect } from './motion/useRevealOnIntersect';
export type {
  UseRevealOnIntersectOptions,
  UseRevealOnIntersectResult,
} from './motion/useRevealOnIntersect';
